...
def _arguments() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--registry", type=Path, default=Path("configs/spatial_perturbation_bridge_candidates_v1.json"))
...
def main() -> int:
    ...
    try:
        ...
        write_bridge_capability_exclusively(options.output, audit_bridge_capability(candidate, summary))
