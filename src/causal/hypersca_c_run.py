...
def _load_public_manifest(
    path: Path,
) -> tuple[Path, dict[str, object], dict[str, str], _FileSnapshot]:
    ...
    return absolute, payload, files, snapshot
...
def run_hypersca_c(
    *,
    ...
    manifest_path, _, public_files, public_manifest_snapshot = _load_public_manifest(
